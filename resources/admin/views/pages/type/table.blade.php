<div class="table">
    @if ($data->count() > 0)
        <div class="table-wrapper">
            <div class="table-header">
                ...
                <div class="row table-row-70 text-start">
                    <span>Name</span>
                </div>
                <div class="row table-row-5">
                    <span></span>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item enable-btn"
                                                            onclick="$onConfirmMessage(
                                                                '{!! route('admin-type-status', ['id' => $item->id, 'status' => 1]) !!}',
                                                ...
                                                @else
                                                    <li>
                                                        <a class="dropdown-item disable-btn"
                                                            onclick="$onConfirmMessage(
                                                                '{!! route('admin-type-status', ['id' => $item->id, 'status' => 2]) !!}',
    ...
    @else
        @component('admin::components.empty',
            [
                'name' => 'Type is empty',
                'msg' => 'You can create a new type by clicking the button below.',
                'permission' => 'type-create',
                'url' => route('admin-type-create'),
                'button' => 'Create Type',
            ])
        @endcomponent
    @endif
