<table>
    <thead>
        <tr>
            <td colspan="11" style="text-align: center;vertical-align:middle;">{{ $date }} Infra_Invoice_Summary
            </td>
        </tr>
        <tr>
    ...
    <tbody>
        @foreach ($data as $key => $item)
            <tr>
                ...
                <td style="vertical-align:middle; text-align:center;{{ $item->type_invoice == 'void_invoice' || $item->type_invoice == 'credit_note' ? 'color:red;' : '' }}">{{ $item?->purchase?->length }}</td>
                ...
                <td style="vertical-align:middle; text-align:center;{{ $item->type_invoice == 'void_invoice' || $item->type_invoice == 'credit_note' ? 'color:red;' : '' }}">{{ $item->type_invoice == 'void_invoice' ? 'Void' : '' }}</td>
            </tr>
        @endforeach
    </tbody>
    <tfoot>
