...
@section('layout')
    <div class="content-wrapper" x-data="xReceivePaymentReport">
        <div class="header">
            @include('admin::shared.header', ['header_name' => 'Submarine Invoice'])
            <div class="header-tab">
                <div class="header-tab-wrapper">
                    <div class="menu-row">
                        <div class="menu-item {!! Request::is('admin/report/summary-invoice/submarine/list') ? 'active' : '' !!}">Data</div>
                    </div>
                </div>
        ...
        <div class="content-body footerTableScroll">
            @include('admin::pages.report.summary_invoice.submarine.table')
            @if (count($data) > 0)
                ...
                this.$store.confirmDialog.open({
                    ...
                    afterClosed: (result) => {
                        if (result) {
                            ...
                            let url = `{{ route('admin-report-summary-invoice-list', 'submarine') }}`
                            Axios.get(url, {
                                headers: {
