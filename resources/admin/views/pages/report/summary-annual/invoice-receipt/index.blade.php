...
@section('layout')
    ...
    <div class="content-wrapper" x-data="xCustomerReport">
        <div class="header">
            @include('admin::shared.header', ['header_name' => 'Invoice & Receipt Summary'])
            <div class="header-tab">
                ...
                <div class="header-action-button">
                    <form class="filter" action="{!! url()->current() !!}" method="GET">
                        <div class="form-row">
                            <select style="width: 200px" name="service_type">
                                <option value="">Select service type...</option>
                                @foreach ($serviceTypes as $serviceType)
                                    <option value="{{ $serviceType->id }}"
                                        {{ request('service_type') == $serviceType->id ? 'selected' : '' }}>
        ...
        <div class="content-body footerTableScroll">
            @include('admin::pages.report.summary-annual.invoice-receipt.table')
        </div>
...
@section('script')
    ...
    $("#year").datepicker({
        ...
        dateFormat: "yy",
        yearRange: "-50:+0", // 50 years before and after the current year
        onClose: function() {
