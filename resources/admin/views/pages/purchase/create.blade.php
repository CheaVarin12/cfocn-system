            ...
            <div class="form-body">
                ...
                <div class="row-2">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" name="contract_number" placeholder="Enter contract number..."
                            x-model="formSubmitData.contract_number" :disabled="formSubmitData.disable">
                ...
                <div class="row-2">
                    <div class="form-row">
                        ...
                        <input type="text" name="location" placeholder="Enter location..."
                            x-model="formSubmitData.location" :disabled="formSubmitData.disable">
                                            ...
                                            if (message == "success") {
                                                ...
                                                this.$store
                                                    ...
                                                    .open({
                                                        data: {
                                                            title: "PAC",
                                                            message: `PAC isset date ${dateValidErr} will disable !`,
                                                            btnClose: "Close",
                                                            btnSave: "Yes",
                                                        }
                                                    });
