<div id="printableArea">
    <div class="invoiceDetailLayout">
        {{-- header --}}
        @include('admin::pages.work-order.credit_note.detail.header')
                ...
                <div class="row">
                    <div class="table customTable">
                        <div class="table-wrapper purchaseInvoice">
                            {{-- header --}}
                            @include('admin::pages.work-order.credit_note.detail.headerTable', [
                                'wLeft' => 50,
                                'wRight' => 50,
                            ])
                            {{-- header --}}
                            ...
                            <div class="table-body">
                                ...
                                {{-- body --}}
                                <template x-for="(item,index) in data?.credit_note_details">
                                ...
                                <div class="column footerInvoiceDetail">
                                    <div class="row table-row-50">
                                        ...
                                        <div x-text="'Note: Ref.NBC Exchang Rate On '+ dateFormat(data?.invoices?.issue_date ?? data?.issue_date) + ' 1 USD= '+ (data?.invoices?.exchange_rate ?? data?.exchange_rate) + 'Riel'  "></div>
        ...
        {{-- footer --}}
        @include('admin::pages.work-order.credit_note.detail.footer')
    </div>
</div>
