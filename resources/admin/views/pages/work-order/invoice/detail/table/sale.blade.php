<div id="printableArea">
    <div class="invoiceDetailLayout" id="printPage">
        {{-- header --}}
        @include('admin::pages.work-order.invoice.detail.header')
                ...
                <div class="row">
                    <div class="table customTable">
                        <div class="table-wrapper purchaseInvoice">
                            {{-- header --}}
                            @include('admin::pages.work-order.invoice.detail.headerTable', [
                                'wLeft' => 45,
                                'wRight' => 55,
                            ])
                            {{-- header --}}
        ...
        {{-- footer --}}
        @include('admin::pages.work-order.invoice.detail.footer')
    </div>
</div>
