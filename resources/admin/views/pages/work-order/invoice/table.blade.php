        ...
        <div class="table-wrapper">
            <div class="table-header">
                <div class="row table-row-3" style="text-align: left;">
                    <span><input style="width: 18px;height:18px;" type="checkbox"
            ...
            <div class="table-body">
                @foreach ($data as $index => $item)
                    <div class="column heightAutos">
                        ...
                        <div class="row table-row-10 text-start">
                            <span> {!! $item->order ? $item->order?->project?->name : '--' !!} </span>
                        </div>
                        <div class="row table-row-10">
                                                ...
                                                @if (checkValidate($item->issue_date))
                                                    ...
                                                    @if (request('status') != 5)
                                                        @can('work-order-invoice')
                                                            ...
                                                            '{!! route('admin-work-order-invoice-delete', $item->id) !!}',
