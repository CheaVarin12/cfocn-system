...
<script>
    Alpine.data('xInvoiceCreateSale', () => ({
        ...
        async init() {
            ...
            try {
                setTimeout(async () => {
                    await this.fetchData(`/admin/work-order/order/create-invoice/${dataStore.id}`, (
                        res) => {
        ...
        calcuatorAmount(type = null) {
            ...
            this.vat.khmer = this.numberRound(this.grand_total.khmer - this.sub_total.khmer, 2);
        },
                        ...
                        afterClosed: (result) => {
                            if (result) {
                                ...
                                let data = {
                                    ...
                                    order_details: this.list_order_details
                                        .length ? JSON
                                        .stringify(this.list_order_details) : [],
                                };
                                setTimeout(() => {
                                    Axios({
