            ...
            <div class="form-body">
                <div class="row-2">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" name="order_number" placeholder="Enter order number..."
                            x-model="formSubmitData.order_number" :disabled="formSubmitData.disable">
                        <template x-for="item in dataError?.order_number">
                    ...
                    <div class="table customTable">
                        <div class="table-wrapper">
                            <div class="table-header">
                                ...
                                <div class="row table-row-35 text-start">
                            ...
                            <div class="table-body">
                                <template x-for="(item,index) in dataForm">
                                    <div class="column">
                                        ...
                                        <div class="row table-row-35 text-start">
                                            <span>
                                                <textarea :disabled="formSubmitData.disable" name="des[]" :class="item.des.error ? 'borderRed' : ''"
                                                    x-model="item.des.value" placeholder="des ..."></textarea>
                                            </span>
                                        </div>
                                        <div class="row table-row-7 text-start">
                                        ...
                                        <div class="row table-row-8 text-start">
                                            <span>
                                                <button type="button" class="delete" @click="removeInput(index)"
                                                    :disabled="formSubmitData.disable">
                ...
                <div class="form-button">
                    ...
                    <button color="danger" :disabled="formSubmitData.disable || submitLoading" type="button"
                        s-click-link="{!! route('admin-order-list', 1) !!}">
                        <i data-feather="x"></i>
                        <span>Cancel</span>
                    </button>
                </div>
    ...
    <script>
        Alpine.data('purchaseForm', () => ({
            ...
            async getServiceByType($event) {
                let id = $event.target.value;
                await Axios.get(`/admin/work-order/order/type-service/${id?id:null}`).then(resp => {
            ...
            calcuatorAmountOld() {
                ...
                this.formSubmitData.total_vat = this.vat.dollar;
                this.vat.khmer = Number(this.vat.dollar.toFixed(2)) * this.exhange_rate;
                this.grand_total.dollar = Number(this.vat.dollar.toFixed(2)) + Number(this.sub_total.dollar
                    .toFixed(2));
                this.grand_total.khmer = this.grand_total.dollar * this.exhange_rate;
                this.sub_total.khmer = this.grand_total.khmer - this.vat.khmer;
            },
            ...
            calcuatorAmount() {
                ...
                this.dataForm.forEach(item => {
                    ...
                    item.amount.value = this.numberRound(Number(item.price.value) * Number(item.qty.value), 2);
                ...
                //khmer
                this.sub_total.khmer = this.numberRound(Number(this.sub_total.dollar) * Number(this.exhange_rate));
                this.vat.khmer = this.numberRound(this.vat.dollar * this.exhange_rate);
                this.grand_total.khmer = this.numberRound(Number(this.grand_total.dollar) * Number(this.exhange_rate));
            },
                                            ...
                                            if (message == "success") {
                                                ...
                                                this.$store
                                                    ...
                                                    .open({
                                                        data: {
                                                            title: "Order",
                                                            message: `Order isset date ${dateValidErr} will disable !`,
                                                            btnClose: "Close",
                                                            btnSave: "Yes",
                                                        }
                                                    });
