<template x-data="{}" x-if="$store.createInvoiceSale.active">
    <div class="dialog" x-data="xInvoiceSale" x-bind:style="{ zIndex: $store.libs.getLastIndex() + 1 }">
                            ...
                            <div class="row-2">
                                <div class="form-row">
                                    ...
                                    <input type="number" name="charge_number" x-model="charge_number"
                                        ...
                                        oninput="validity.valid||(value='');" @input="calculatorAmount">
                                                            ...
                                                            <div class="row table-row-10">
                                                                <span>
                                                                    <div class="installNumber">
                                                                        <span
                                                                            x-text="install_number?install_number:0"></span>
                                                                        <span> / </span>
                                                                        <span
                                                                            x-text="charge_number?charge_number:0"></span>
                                                                    </div>
                                                                </span>
...
<script>
    Alpine.data('xInvoiceSale', () => ({
                        ...
                        afterClosed: (result) => {
                            if (result) {
                                ...
                                let data = {
                                    ...
                                    po_id: this.pac_id.length > 0 ? this.pac_id[
                                            0]
                                        ._id : null,
        ...
        dialogClose() {
            this.$store.createInvoiceSale.active = false;
        },
        calculatorAmountEachPac(type = null) {
            ...
            this.pacData.forEach(element => {
                ...
                element._purchase_detail.forEach((item) => {
                    ...
                    if (type != "amount") {
                        item.amount = this.numberRound(item.price * Number(item.qty) / this
                            .install, 2);
                    }
                ...
                if (this.tax_status != 2) {
                    this.total_child_invoice.vat.dollar = this.numberRound(
                        this.total_child_invoice.sub_total.dollar * 0.1,
                        2
                    );
                }

                this.total_child_invoice.grand_total.dollar = this.numberRound(
                    this.total_child_invoice.sub_total.dollar + this.total_child_invoice.vat
                    .dollar,
                    2
                );
...
<script>
    Alpine.store('createInvoiceSale', {
        active: false,
        options: {
            data: null,
            selected: null,
    ...
    window.createInvoiceSale = (options) => {
        Alpine.store('createInvoiceSale', {
            active: true,
            options: {
                ...Alpine.store('createInvoiceSale').options,
                ...options
            }
        });
    };
