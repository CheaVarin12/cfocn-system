        ...
        <div class="table">
            <div class="table-header">
                ...
                <p class="size-11 m-0" align="center">HP: (+855)023 888 022/ 086 822 173&nbsp;&nbsp;&nbsp; Fax: +855-23
                    886 600</p>
                <p class="size-11 m-0" align="center">ទូរស័ព្ទលេខ (+៨៥៥) ០២៣ ៨៨៨ ០២២/ ០៨៦​​​ ៨២២​​​​ ១៧៣</p>
                <p class="size-11 m-0 font-bold" align="center" style="margin-top: 15px;">វិក្កយបត្រអាករ</p>
            ...
            <div class="table-body">
                <table class="w-100">
                    <thead>
                        <tr>
                            <th class="w-40" colspan="3" align="left" style="font-weight: unset">
                                ឈ្មោះក្រុមហ៊ុន&nbsp;:&nbsp;{{ $data?->dataCustomer?->name_kh ?? '' }}
                            </th>
                            <th class="w-60" colspan="5" align="left" style="font-weight: unset">
                                លេខរៀងវិក្កយបត្រ/​ Invoice&nbsp;:&nbsp;{{ $data->invoice_number ?? '' }}
                            </th>
                        </tr>
                        <tr>
                            <th class="w-40" colspan="3" align="left" style="font-weight: unset">
                        ...
                        <tr>
                            ...
                            <th class="w-60" colspan="5" align="left" style="font-weight: unset">លេខកិច្ចសន្យា/
                        ...
                        <tr>
                            <th class="w-40" colspan="3" align="left" style="font-weight: unset">អ្នកទទួល /
                                Attention :
                            </th>
                            <th class="w-60" colspan="5" align="left" style="font-weight: unset">Ref :
                            </th>
                        </tr>
                        <tr>
                            <th class="w-40" colspan="3" align="left" style="font-weight: unset">
                            ...
                            <th class="w-60" colspan="5" align="left" style="font-weight: unset"></th>
                        </tr>
                        ...
                        <tr style="background: #c4d69b">
                            ...
                            <th class="font-bold" style="width: 25%">
                            ...
                            <th class="font-bold">
                                អត្រាប្រចាំឆ្នាំ<br>Annual Rate(%)
                            </th>
                            <th class="font-bold">
                                ថ្លៃទំនិញ($)<br>Amount($)
                            </th>
                    ...
                    <tbody>
                        ...
                        @endforeach
                        <tr>
                            <td colspan="5" rowspan="3" style="width: auto">
                                Remark&nbsp;:&nbsp;{{$data?->remark??''}}
                                <br><br>
                                Note&nbsp;:&nbsp;Ref.NBC Exchang Rate On&nbsp;{{formatDate($data?->issue_date,'DD MMM Y')}}&nbsp;1&nbsp;USD&nbsp;=&nbsp;{{$data?->exchange_rate}}&nbsp;Riel<br><br>{{$data?->note??''}}
                            </td>
                            <td style="text-align: right; font-size: 11px;width: 15%;">
                                សរុប<br>Sub total
                            </td>
                            <td>
                                <table class="space-between-table">
