<template x-data="{}" x-if="$store.editInvoiceMultiplePacLeasing.active">
    <div class="dialog" x-data="xEditInvoiceMultiplePacLeasing" x-bind:style="{ zIndex: $store.libs.getLastIndex() + 1 }">
...
<script>
    Alpine.data('xEditInvoiceMultiplePacLeasing', () => ({
        submitLoading: false,
        sub_total: {
            dollar: 0,
            khmer: 0
        ...
        async init() {
            ...
            let dataStore = this.$store.editInvoiceMultiplePacLeasing.options.data;
        ...
        dialogClose() {
            this.$store.editInvoiceMultiplePacLeasing.active = false;
        },
        groupInvoiceDetail() {
...
<script>
    Alpine.store('editInvoiceMultiplePacLeasing', {
        active: false,
        options: {
            data: null,
            selected: null,
    ...
    window.editInvoiceMultiplePacLeasing = (options) => {
        Alpine.store('editInvoiceMultiplePacLeasing', {
            active: true,
            options: {
                ...Alpine.store('editInvoiceMultiplePacLeasing').options,
                ...options
            }
        });
    };
