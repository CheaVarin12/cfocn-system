                ...
                <table class="w-100">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="w-60" colspan="5" align="left" style="font-weight: unset">រយៈកាលបរិច្ឆេទ/
                                Invoice
                        ...
                        <tr>
                            ...
                            <th class="w-60" colspan="5" align="left" style="font-weight: unset">Ref&nbsp;:&nbsp;{{$data?->invoice_number??''}}
                            </th>
                        </tr>
                        <tr>
                            <th class="w-40" colspan="3" align="left" style="font-weight: unset">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="3" rowspan="3">
                                ...
                                On&nbsp;{{ formatDate($data?->invoices?->issue_date ?? $data?->issue_date, 'DD MMM Y') }}&nbsp;1&nbsp;USD&nbsp;=&nbsp;{{ $data?->exchange_rate }}&nbsp;Riel<br><br>{{ $data?->note ?? '' }}
                            </td>
