        ...
        <div class="table">
            <div class="table-header">
                <div class="logo" style="height: 100px;width: 100%;">
                    {{-- <img width="100%" src="https://cfocn.phsartech.com/images/Capture.png" alt=""
                        style="height: 100px;"> --}}
                        <img width="100%" src="{{ public_path('images/Capture.png') }}" alt="" style="height: 100px;">
                </div>
                ...
                <p class="size-11 m-0" align="center">លេខអត្តសញ្ញាណកម្ម អតប
                    (VATIN)&nbsp;:&nbsp;{{ $data?->purchase?->project?->vat_tin ?? '' }}</p>
                ...
                <table class="w-100">
                    <thead>
                        <tr>
                            ...
                            <th class="w-50" colspan="5" align="left" style="font-weight: unset">
                        ...
                        <tr>
                            ...
                            <th class="w-50" colspan="5" align="left" style="font-weight: unset">រយៈកាលបរិច្ឆេទ/
                                Invoice
                        ...
                        <tr>
                            <th class="w-50" colspan="4" align="left" style="font-weight: unset">
                                Address&nbsp;:&nbsp;{{ $data?->dataCustomer?->address_en ?? '' }}</th>
                            <th class="w-50" colspan="5" align="left" style="font-weight: unset">លេខកិច្ចសន្យា/
                                Contract No. : {{ $data?->contract_number ?? '' }}
                            </th>
                        </tr>
                        <tr>
                            <th class="w-50" colspan="4" align="left" style="font-weight: unset">
                                ទូរសព្ទ័លេខ/Telephone&nbsp;:&nbsp;{{ $data?->dataCustomer?->phone ?? '' }}</th>
                            <th class="w-50" colspan="5" align="left" style="font-weight: unset">
                                P.O.Nº&nbsp;:&nbsp;{{ $data?->invoices?->po_number ?? $data?->purchase?->po_number }}</th>
                        </tr>
                        <tr>
                            <th class="w-50" colspan="4" align="left" style="font-weight: unset">អ្នកទទួល /
                                Attention :
                            </th>
                            <th class="w-50" colspan="5" align="left" style="font-weight: unset">Ref&nbsp;:&nbsp;{{$data?->invoice_number??''}}
                            </th>
                        </tr>
                        <tr>
                            <th class="w-50" colspan="4" align="left" style="font-weight: unset">
                            ...
                            <th class="w-50" colspan="5" align="left" style="font-weight: unset"></th>
                        </tr>

                        <tr style="background: #c4d69b">
                            <th class="font-bold" style="width: 5%">
                                ល.រ<br>No
                            </th>
                            ...
                            <th class="font-bold" style="width: 10%">
                                បរិមាណ<br>Quality
                            </th>
                            <th class="font-bold" style="width: 10%">
                                ឯកតា<br>UOM
                            ...
                            <th class="font-bold" style="width: 10%">
                                អត្រាប្រចាំឆ្នាំ<br>Annual Rat
                            </th>
                            <th class="font-bold"style="width: 10%">
                                អត្រាប្រចាំឆ្នាំ<br>Annual Rat
                            </th>
                        ...
                        <tr>
                            <th></th>
                            <th></th>
                            <th class="font-bold">{{ $data?->purchase?->project?->name ?? '' }}</th>
                            <th></th>
                            <th></th>
                            <th></th>
                            <th></th>
                    ...
                    <tbody>
                        @foreach ($data->creditNoteDetail as $index => $item)
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <table class="space-between-table">
                                        <tr>
                                            ...
                                            <td class="text-right">{{ $item?->price ? number_format((float) $item->price, 2) : '' }}</td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="text-align: center">{{$item?->rate_first}}</td>
                                <td style="text-align: center">{{$item?->rate_second}}</td>
                                <td>
                                    <table class="space-between-table">
                                        <tr>
                                            <td class="text-left">$</td>
                                            <td class="text-right">{{ $item?->amount ? number_format((float) $item->amount, 2) : '' }}</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        <tr>
                            <td colspan="5" rowspan="3">
                                Remark&nbsp;:&nbsp;{{$data?->remark??''}}
                                <br><br>
                                Note&nbsp;:&nbsp;Ref.NBC Exchang Rate On&nbsp;{{ formatDate($data?->invoices?->issue_date ?? $data?->issue_date, 'DD MMM Y') }}&nbsp;1&nbsp;USD&nbsp;=&nbsp;{{$data?->exchange_rate}}&nbsp;Riel<br><br>{{$data?->note??''}}
                            </td>
                            ...
                            <td>
                                <table class="space-between-table">
                                    <tr>
                                        <td class="text-left">$</td>
                                        <td class="text-right">{{ $data?->total_price ? number_format((float) $data->total_price, 2) : '' }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                                <table class="space-between-table">
                                    <tr>
                                        ...
                                        <td class="text-right">{{ $data?->total_price_kh ? number_format((float) $data->total_price_kh) : '' }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table class="space-between-table">
                                    <tr>
                                        <td class="text-left">$</td>
                                        <td class="text-right">{{ $data?->vat ? number_format((float) $data->vat, 2) : '' }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                                <table class="space-between-table">
                                    <tr>
                                        <td class="text-left">R</td>
                                        <td class="text-right">{{ $data?->vat_kh ? number_format((float) $data->vat_kh) : '' }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <table class="space-between-table">
                                    <tr>
                                        <td class="text-left">$</td>
                                        <td class="text-right">{{ $data?->total_grand ? number_format((float) $data->total_grand, 2) : '' }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                                <table class="space-between-table">
                                    <tr>
                                        <td class="text-left">R</td>
                                        <td class="text-right">{{ $data?->total_grand_kh ? number_format((float) $data->total_grand_kh) : '' }}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <tbody>
                        <tr>
                            <td style="width: 33%; border: none; text-align: center;    padding: 0px 35px 0 0;">
                                <hr>
                                ហត្ថលេខា និង ឈ្មោះអ្នកទិញ<br>Customer's Signature & Name
                            </td>
                            <td style="width: 33%; border: none; text-align: center;    padding: 0px 35px 0 0;">
                                <hr>
                                ត្រួតពិនិត្យដោយ<br>Approved By
                            </td>
                            <td style="width: 33%; border: none; text-align: center;">
                                <hr>
                                ហត្ថលេខា និង ឈ្មោះអ្នកលក់<br>Seller's Signature & Name
                            </td>
                        </tr>
                    </tbody>
                </table>
