<div id="printableArea">
    <div class="invoiceDetailLayout">
        {{-- header --}}
        @include('admin::pages.credit_note.detail.header')
                ...
                <div class="row">
                    <div class="table customTable">
                        <div class="table-wrapper purchaseInvoice">
                            {{-- header --}}
                            @include('admin::pages.credit_note.detail.headerTable', [
                                'wLeft' => 45,
                                'wRight' => 55,
                            ])
                            {{-- header --}}
                            ...
                            <div class="table-body">
                                ...
                                {{-- body --}}
                                <template x-for="(item,index) in data?.credit_note_detail">
                                    <div class="column" id="columnIDInvoiceDetail">
                                        ...
                                        <div class="row table-row-25 ivDes">
                                        ...
                                        <div class="row table-row-10">
                                            <span class="text-center"
                                                x-text="(data?.install_number??0)+' / '+(data?.charge_number??0)"></span>
                                        </div>
                                        <div class="row table-row-15">
                                            <div class="text-spaceBetween">
                                                <span>$</span>
                                ...
                                <div class="column footerInvoiceDetail">
                                    <div class="row table-row-45">
                                        ...
                                        <div class="inputTextArea" style="padding: 2px;word-break: break-word;">
                                            <div
                                                x-text="'Note: Ref.NBC Exchang Rate On '+
                                        dateFormat(data?.invoices?.issue_date ?? data.issue_date) + 
                                        ' 1 USD= '+ data?.exchange_rate + 'Riel'
                                ">
                                            </div>
                                            <div x-text="data?.note??''" style="word-break: break-word;"></div>
                                        </div>
                                    </div>
                                    <div class="row table-row-55 right">
                                        <div class="column">
                                        ...
                                        <div class="column">
                                            ...
                                            <div class="row table-row-40">
                                                <div class="divTag text-spaceBetween">
                                                    <span>$</span>
                                                    <span
                                                        x-text="numberFormatEn(numberRound(data?.total_grand, 2))"></span>
                                                </div>
                                            </div>
                                            <div class="row table-row-30">
                                                <div class="divTag text-spaceBetween">
                                                    <span>R</span>
                                                    <span
                                                        x-text="numberFormatKh(numberRound(data?.total_grand_kh))"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        {{-- footer --}}
        @include('admin::pages.credit_note.detail.footer')
    </div>
</div>
