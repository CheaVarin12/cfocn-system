...
@section('layout')
    <div class="content-wrapper" x-data="XData">
        <div class="header">
            ...
            <div class="header-tab">
                <div class="header-tab-wrapper">
                    <div class="menu-row">
                        <div class="menu-item {!! Request::is('admin/receipt/list/1') ? 'active' : '' !!}" s-click-link="{!! route('admin-receipt-list', 1) !!}">
                            Pending</div>
                        <div class="menu-item {!! Request::is('admin/receipt/list/2') ? 'active' : '' !!}" s-click-link="{!! route('admin-receipt-list', 2) !!}">
                            Paid</div>
                        <div class="menu-item {!! Request::is('admin/receipt/list/all') ? 'active' : '' !!}" s-click-link="{!! route('admin-receipt-list', 'all') !!}">
                            All</div>
                    </div>
                </div>
        ...
        <div class="content-body">
            @include('admin::pages.receipt.table')
        </div>
    </div>
    @include('admin::pages.receipt.detail.index')
    @include('admin::pages.receipt.create.create')
    @include('admin::pages.receipt.edit.edit-status')
    @include('admin::pages.receipt.edit.editReceipt')
    @include('admin::pages.receipt.edit.editInvoice')
@stop
@section('script')
    <script>
    ...
    <script>
        Alpine.data('XData', () => ({
            ...
            editDialog(item) {
                let formDialog = item.status_type == "receipt" ? edit : editReceiptInvoice;
                formDialog({
                    active: true,
                    data: {
                        ...item
