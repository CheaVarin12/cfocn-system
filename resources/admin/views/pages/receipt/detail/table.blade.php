<div id="printableArea">
    ...
    <div class="receiptDetailLayout" id="printPage">
        {{-- header --}}
        @include('admin::pages.receipt.detail.header')

        <div id="form" class="form-wrapper">
            {{-- header --}}
            @include('admin::pages.receipt.detail.headerTable', [
                'wLeft' => 70,
                'wRight' => 30,
            ])
            {{-- header --}}
                                        ...
                                        <div class="column" style="height: 25% !important;">
                                            ...
                                            <div class="row table-row-50">
                                                <div class="divTag text-spaceBetween">
                                                    <span>$</span>
                                                    <span
                                                        x-text="numberFormat(numberRound(data?.total_price, 2))"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column" style="height: 25% !important;">
                                        ...
                                        <div class="column" style="height: 25% !important;">
                                            ...
                                            <div class="row table-row-50">
                                                <div class="divTag text-spaceBetween">
                                                    <span>$</span>
                                                    <span
                                                        x-text="numberFormat(numberRound(data?.total_grand, 2))"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="column" style="height: 25% !important;">
        ...
        {{-- footer --}}
        @include('admin::pages.receipt.detail.footer')
