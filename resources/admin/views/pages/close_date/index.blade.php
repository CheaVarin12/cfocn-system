...
@section('layout')
    <div class="content-wrapper">
        <div class="header">
            @include('admin::shared.header', ['header_name' => 'Close date Management'])
            <div class="header-tab">
                <div class="header-tab-wrapper">
                    <div class="menu-row">
                        <div class="menu-item {!! Request::is('admin/close-date/list/1') ? 'active' : '' !!}" s-click-link="{!! route('admin-close-date-list', 1) !!}">
                            @lang('adminGlobal.tab.active')</div>
                        <div class="menu-item {!! Request::is('admin/close-date/list/2') ? 'active' : '' !!}" s-click-link="{!! route('admin-close-date-list', 2) !!}">
                ...
                <div class="header-action-button">
                    ...
                    @can('close-date')
                        <button class="btn-create" s-click-link="{!! route('admin-close-date-create') !!}">
                            <i data-feather="plus-circle"></i>
                            <span>Create close date</span>
                        </button>
                    @endcan
        ...
        <div class="content-body">
            @include('admin::pages.close_date.table')
        </div>
    </div>
@stop
@section('script')
        ...
        $("body").on("click", ".trash-btn", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    if (result.value == 1) {
                        $.ajax({
                            url: `/admin/close-date/delete/${id}`,
                            method: 'GET',
