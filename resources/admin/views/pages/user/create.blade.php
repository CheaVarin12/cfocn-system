            ...
            <div class="form-body">
                <div class="row-2">
                    <div class="form-row">
                        ...
                        <input type="text" name="name" value="{!! request('id') ? $data->username : old('name') !!}"
                ...
                <div class="row-2">
                    <div class="form-row">
                        ...
                        <div class="form-select-photo image">
                            <div class="select-photo {!! request('id') && isset($data) && $data->avatar != null ? 'active' : '' !!}">
                                <div class="icon">
                            ...
                            <div class="image-view {!! request('id') && isset($data) && $data->avatar != null ? 'active' : '' !!}" >
                                <img src="{!! request('id') && isset($data) && $data->avatar != null ? asset('file_manager' . $data->avatar) : null !!}"  onerror="(this).src='{{ asset('images/logo/default.png') }}'" alt="">
                            </div>
                            <input type="text" name="avatar" s-click-fn="selectImage(event)" autocomplete="off"
                                role="presentation">
                            <input type="hidden" name="tmp_file" value="{!! request('id') && isset($data) && $data->avatar != null ? $data->avatar : '' !!}">
                        </div>
                    </div>
                </div>
