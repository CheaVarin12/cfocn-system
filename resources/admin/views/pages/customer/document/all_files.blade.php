<div class="file-manager-wrapper pt-5 pe-5 ps-5" x-data="fileManager">
    ...
    <div class="file-manager-body">
        ...
        <div class="file-side">
            @include('admin::pages.customer.document.menu')
    ...
    <template x-if="dialog.component.createFolderDialog">
        @include('admin::pages.customer.document.create-folder')
    </template>
    <template x-if="dialog.component.renameFolderDialog">
        @include('admin::pages.customer.document.rename-folder')
    </template>
    <template x-if="dialog.component.uploadFileDialog">
        @include('admin::pages.customer.document.upload-file')
    </template>
    <template x-if="dialog.component.confirmDialog">
        @include('admin::pages.customer.document.trash-dialog')
    </template>
    ...
    <script>
        Alpine.data('fileManager', () => ({
            ...
            getData(params = {}) {
                ...
                Axios
                    .get(`{{ route('admin-customer-first',$customer->id) }}`, {
                        params: params,
                    })
                    .then((data) => {
                        this.filePage += 1;
            ...
            getFile(params = {}, next) {
                ...
                Axios
                    .get(`{{ route('admin-customer-files',$customer->id) }}`, {
                        params: params,
                    })
                    .then((data) => {
