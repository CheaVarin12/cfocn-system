<div class="file-manager-wrapper pt-5 pe-5 ps-5" x-data="fileManager">
    ...
    <div class="file-manager-body">
        ...
        <div class="file-side">
            @include('admin::pages.document.receipt.menu')
    ...
    <template x-if="dialog.component.createFolderDialog">
        @include('admin::pages.document.receipt.create-folder')
    </template>
    <template x-if="dialog.component.renameFolderDialog">
        @include('admin::pages.document.receipt.rename-folder')
    </template>
    <template x-if="dialog.component.uploadFileDialog">
        @include('admin::pages.document.receipt.upload-file')
    </template>
    <template x-if="dialog.component.confirmDialog">
        @include('admin::pages.document.receipt.trash-dialog')
    </template>
    ...
    <script>
        Alpine.data('fileManager', () => ({
            ...
            getData(params = {}) {
                ...
                Axios
                    .get(`{{ route('admin-document-first-receipt') }}`, {
                        params: params
                    })
                    .then((data) => {
                        this.filePage += 1;
            ...
            getFile(params = {}, next) {
                ...
                Axios
                    .get(`{{ route('admin-document-files-receipt') }}`, {
                        params: params
                    })
                    .then((data) => {
