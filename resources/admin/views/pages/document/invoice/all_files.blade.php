<div class="file-manager-wrapper pt-5 pe-5 ps-5" x-data="fileManager">
    ...
    <div class="file-manager-body">
        ...
        <div class="file-side">
            @include('admin::pages.document.invoice.menu')
    ...
    <template x-if="dialog.component.createFolderDialog">
        @include('admin::pages.document.invoice.create-folder')
    </template>
    <template x-if="dialog.component.renameFolderDialog">
        @include('admin::pages.document.invoice.rename-folder')
    </template>
    <template x-if="dialog.component.uploadFileDialog">
        @include('admin::pages.document.invoice.upload-file')
    </template>
    <template x-if="dialog.component.confirmDialog">
        @include('admin::pages.document.invoice.trash-dialog')
    </template>
    ...
    <script>
        Alpine.data('fileManager', () => ({
            ...
            getData(params = {}) {
                ...
                Axios
                    .get(`{{ route('admin-document-first-invoice') }}`, {
                        params: params
                    })
                    .then((data) => {
                        this.filePage += 1;
            ...
            getFile(params = {}, next) {
                ...
                Axios
                    .get(`{{ route('admin-document-files-invoice') }}`, {
                        params: params
                    })
                    .then((data) => {
