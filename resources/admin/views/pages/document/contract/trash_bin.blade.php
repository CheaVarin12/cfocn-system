<div class="file-manager-wrapper p-5" x-data="trashBin">
    ...
    <template x-if="dialog.component.confirmDeleteDialog">
        @include('admin::pages.document.contract.confirm-delete-dialog')
    </template>
    <template x-if="dialog.component.confirmRestoreDialog">
        @include('admin::pages.document.contract.confirm-restore-dialog')
    </template>
    ...
    <template x-if="tooltip.show && !contentMenu.show">
        <div class="tooltipX" :style="`top:${tooltip.y}px;left:${tooltip.x}px`">
            ...
            <p>@lang('file-manager.tooltip.deleted_at') : <span x-text="moment(tooltip.data?.deleted_at).calendar()"></span></p>
        </div>
    </template>
    <script>
