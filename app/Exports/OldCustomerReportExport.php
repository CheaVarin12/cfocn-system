...
class OldCustomerReportExport implements FromView, WithEvents, WithTitle
{
  public $pac;
  ...
  {
    return view("admin::pages.report.old_customer.excel", ['pac' => $this->pac]);
  }
  ...
  public function registerEvents(): array
  {
    return [
      AfterSheet::class => function (AfterSheet $event) {
        ...
        $event->sheet->getStyle("A2:M$end_row")->applyFromArray([
          'borders' => [
            'allBorders' => [
