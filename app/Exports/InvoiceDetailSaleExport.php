...
class InvoiceDetailSaleExport implements FromView, WithEvents
{
  public $invoice;
  ...
  public function __construct($data)
  {
    ...
    $this->rate = $data['rate'];
    $this->count_invoice = $data['count_invoice'];
  ...
  public function view(): view
  {
    ...
    return view("admin::pages.invoice.excel-invice-sale-export", [
